...
var entradaTexto = document.querySelector(
  ".entrada-textarea"
);
var textoRecebido = entradaTexto.value;
var criptografiaBotao = document.querySelector(
  ".button-cripto"
);

function criptografar() {
  var textoRecebido =
    entradaTexto.value.toLowerCase();
  ...
  if (validar(entradaTexto.value)) {
    var erroValidacao = document.querySelector(
      ".icon-texto"
    );
